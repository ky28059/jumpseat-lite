...
export default function MockPage(props: MockPageProps) {
    return (
        <div className="rounded-lg border border-tertiary bg-content shadow-xl w-full lg:w-xl xl:w-184 flex-none">
            <div className="flex gap-2 items-center pt-2 pb-1.5 px-4 border-b border-tertiary bg-gray-100 dark:bg-background/75 rounded-t-lg">
                ...
                <div className="ml-2 flex items-center gap-6 text-xs text-secondary font-medium border-x border-t border-tertiary rounded-t-md px-3.5 py-2 -mb-[calc(0.375rem+1px)] bg-content">
                    Jumpseat
